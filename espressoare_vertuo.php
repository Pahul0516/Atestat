    ...
    <body>
            <div id="tot">
                ...
                <div class="mid">
                    ...
                    <div class="gradient">
                        <div class="scris">
                           <h1 style="font-size:37px">APARATE DE CAFEA VERTUO</h1>
                    ...
                    <div class="butoane">
                        ...
                        <a href="espressoare_original.php" style="color:#17171A;"> <button><img src="Imagini/espressor_original2.webp"  width="100%" style="vertical-align: -12px;"><br> Original </button> </a>
                        
                        <button style="text-decoration: underline"><img src="Imagini/espressor_vertou2.webp" width="100%" style="vertical-align: -12px;"><br> Vertuo</button>
                    </div>
                    <br><br><br>
                    ...
                    <div class="container">
                        ...
                        <?php
                            $sql2="SELECT * FROM `espressoare` WHERE `original`= 0";
