<html>
    ...
    <title>Admin kit de decalcifiere</title>
        ...
        <div class="mijloc">
            <div class="container">
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" placeholder="numele kit-ului" name="nume" ><br>
                ...
                <?php
                    ...
                    if(isset($_POST['buton'])) 
                    {
                        ...
                        $caleapoza_posibila="Imagini_decalcifiere/".basename($_FILES["poza"]["name"]);
                        ...
                        if ($_FILES['poza']['size']<=1000000000)
                        {
                            ...
                            $caleapoza="Imagini_decalcifiere/".$_FILES['poza']['name'];
                            $sql1 = "SELECT * FROM `kit_de_decalcifiere` WHERE `nume` = '$nume'";
                            $rez1 = mysqli_query($id_con,$sql1);
                            if(mysqli_num_rows($rez1)==0)
                            {
                                if(is_uploaded_file($_FILES['poza']['tmp_name']))
                                {   ///daca s-a incarcat complet
                                move_uploaded_file($_FILES['poza']['tmp_name'],"Imagini_decalcifiere/".$_FILES['poza']['name']);     ///mutam fisierul temporar in fisierul imagini cu numele convenabil
                                }
                                echo("adaugat");
                                $sql2="INSERT INTO kit_de_decalcifiere (`nume`,`pret`,`stoc`,`imagine`) VALUES ('$nume','$pret','$stoc','$caleapoza');";
            ...
            <form method="post"> 
                <select name="sterge">
                 <?php
                    $sql3 = "SELECT `id_kit_de_decalcifiere`, `nume` FROM `kit_de_decalcifiere` WHERE 1";
                ...
                <?php
                    ...
                    {
                        $id=$_POST['sterge'];
                        $sql4="SELECT`imagine` FROM kit_de_decalcifiere WHERE id_kit_de_decalcifiere='$id'";
                        ...
                        $sql5="DELETE FROM kit_de_decalcifiere WHERE `id_kit_de_decalcifiere` = '$id'";
                        mysqli_query($id_con, $sql5);
                        echo("Kit de decalcifiere stears");
                    }
                ?>
                <br>
