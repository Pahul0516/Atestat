        ...
        <div class="mijloc">
            <div class="container">
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" placeholder="numele biscuitilor" name="nume" ><br>
                ...
                <?php
                    ...
                    if(isset($_POST['buton'])) 
                    {
                        ...
                        $caleapoza_posibila="Imagini_biscuiti/".basename($_FILES["poza"]["name"]);
                        ...
                        if ($_FILES['poza']['size']<=1000000000)
                        {
                            ...
                            $caleapoza="Imagini_biscuiti/".$_FILES['poza']['name'];
                            $sql1 = "SELECT * FROM `biscuiti` WHERE `nume` = '$nume'";
                            $rez1 = mysqli_query($id_con,$sql1);
                            if(mysqli_num_rows($rez1)==0)
                            {
                                if(is_uploaded_file($_FILES['poza']['tmp_name']))
                                {   ///daca s-a incarcat complet
                                move_uploaded_file($_FILES['poza']['tmp_name'],"Imagini_biscuiti/".$_FILES['poza']['name']);     ///mutam fisierul temporar in fisierul imagini cu numele convenabil
                                }
                                echo("adaugat");
                                $sql2="INSERT INTO biscuiti (`nume`,`pret`,`stoc`,`imagine`) VALUES ('$nume','$pret','$stoc','$caleapoza');";
            ...
            <form method="post"> 
                <select name="sterge">
                 <?php
                    $sql3 = "SELECT `id_biscuiti`, `nume` FROM `biscuiti` WHERE 1";
                ...
                <?php
                    ...
                    {
                        $id=$_POST['sterge'];
                        $sql4="SELECT`imagine` FROM biscuiti WHERE id_biscuiti='$id'";
                        ...
                        $sql5="DELETE FROM biscuiti WHERE `id_biscuiti` = '$id'";
                        mysqli_query($id_con, $sql5);
                        echo("Cutie de biscuiti stearsa");
                    }
                ?>
                                <br>
